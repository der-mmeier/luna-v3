...
- Connection Workspace Sharing v2.7.3 ergänzt: Connections behalten einen eindeutigen Owner Workspace und können über `luna_connection_workspaces` explizit für weitere Workspaces freigegeben werden; Admin-Selects, TransferDB-Auswahl, Delete Guard und Endpoint-Exporte nutzen Owner/shared Visibility und exportieren keine Secrets.
