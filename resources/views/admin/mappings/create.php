...
<form class="card admin-card" method="post" action="<?= isset($values['id']) ? '/admin/mappings/' . (int) $values['id'] : '/admin/mappings' ?>">
    <div class="card-body row g-3">
        ...
        <div class="col-md-6">
            ...
            <select class="form-select" id="source_connection_id" name="source_connection_id">
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" id="source_table" name="source_table" value="<?= htmlspecialchars((string) ($values['source_table'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
        </div>
        <div class="col-md-6">
            <label class="form-label" for="target_connection_id">Target Connection</label>
            <select class="form-select" id="target_connection_id" name="target_connection_id">
                <option value="">Bitte wählen</option>
                <?php foreach ($connections ?? [] as $connection): ?>
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" id="target_table" name="target_table" value="<?= htmlspecialchars((string) ($values['target_table'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
        </div>
    </div>
